...
export const products: Product[] = [
  ...
  { title: 'Der Candy-Fluch und die Rache der Gräfin Bitterzahn', description: 'Halloween-Abenteuer', level: 'Klassen 6–13', image: '/assets/products/candy-fluch.png', category: 'escape', status: 'Halloween', featured: true, shopUrl: 'https://eduescapeacademy.thrivecart.com/candy-fluch/?ref=landingpage' },
  { title: 'Das Geheimnis der Wörterinsel', description: 'Escape Room zu Rechtschreibstrategien für die Grundschule', level: 'Klassen 2–5', image: '/assets/products/woerterinsel.png', category: 'escape', status: 'Bald einzeln erhältlich' },
  ...
  { title: 'Der Fluch Interpunctum', description: 'Escape Room rund um Zeichensetzung', image: '/assets/products/interpunctum.png', category: 'escape' },
  { title: 'Mission Metapher', description: 'Stilmittel und Lyrik als spannendes Abenteuer', image: '/assets/products/mission-metapher.png', category: 'escape', shopUrl: 'https://eduescapeacademy.thrivecart.com/escape-room-mission-metapher/?ref=landingpage' },
  ...
  { title: 'Mitternacht in Blackwood Manor', description: 'Eine kriminelle Lesespurgeschichte', image: '/assets/products/blackwood-1.jpg', category: 'lesespuren', shopUrl: 'https://eduescapeacademy.thrivecart.com/mitternacht-in-blackwood-manor/?ref=landingpage' },
  { title: 'Blackwood Manor 2 – Spiel mit dem Leben', description: 'Eigenständig spielbare Geschichte im Blackwood-Setting', image: '/assets/products/blackwood-2.png', category: 'lesespuren', shopUrl: 'https://eduescapeacademy.thrivecart.com/blackwood-zwei/?ref=landingpage' },
  { title: 'Die Blackwood-Abenteuer', description: 'Beide Lesespurgeschichten im Bundle', image: '/assets/products/blackwood-bundle.png', category: 'lesespuren', shopUrl: 'https://eduescapeacademy.thrivecart.com/blackwood-collection/?ref=landingpage' },
  ...
  { title: 'Dein Adventskalender mit Genially', description: 'Genially kennenlernen und einen eigenen digitalen Adventskalender gestalten', image: '/assets/products/adventskalender.png', category: 'workshops', status: 'Demnächst', featured: true },
];
