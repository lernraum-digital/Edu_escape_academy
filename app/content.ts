...
export const products: Product[] = [
  ...
  { title: 'Das Geheimnis der Wörterinsel', description: 'Escape Room zu Rechtschreibstrategien für die Grundschule', level: 'Klassen 2–5', image: './assets/products/woerterinsel.png', mobileImage: './assets/products/woerterinsel-mobile.png', category: 'escape', status: 'Bald einzeln erhältlich', shopUrl: 'https://eduescapeacademy.thrivecart.com/geheimnis-woerterinsel/' },
  { title: 'Mission Alpha – Special Agent Training', description: 'Rätsel-Escape-Room für Vertretungsstunden', level: 'Klassen 6–13', image: './assets/products/mission-alpha.png', mobileImage: './assets/products/mission-alpha-mobile.png', category: 'escape', shopUrl: 'https://eduescapeacademy.thrivecart.com/mission-alpha/?ref=landingpage' },
  { title: 'Der Fluch Interpunctum', description: 'Escape Room rund um Zeichensetzung', level: 'Klassen 6/7–13', image: './assets/products/interpunctum.png', mobileImage: './assets/products/interpunctum-mobile.png', category: 'escape', shopUrl: 'https://eduescapeacademy.thrivecart.com/fluch-interpunctum/?ref=landingpage' },
  { title: 'Mission Metapher', description: 'Stilmittel und Lyrik als spannendes Abenteuer', level: 'Klassen 7–13', image: './assets/products/mission-metapher.png', mobileImage: './assets/products/mission-metapher-mobile.png', category: 'escape', shopUrl: 'https://eduescapeacademy.thrivecart.com/escape-room-mission-metapher/?ref=landingpage' },
  { title: 'Operation LinguaBot', description: 'EduBreakout rund um Wortarten', level: 'Klassen 6–13', image: './assets/products/linguabot.png', mobileImage: './assets/products/linguabot-mobile.png', category: 'escape', shopUrl: 'https://eduescapeacademy.thrivecart.com/escape-room-linguabot/?ref=landingpage' },
  { title: 'Santas Schlittenherz – Rettung in letzter Minute', description: 'Ein weihnachtlicher Escape Room', level: 'Klassen 5–13', image: './assets/products/schlittenherz.png', mobileImage: './assets/products/schlittenherz-mobile.png', category: 'escape', status: 'Wird vor der Saison geprüft', shopUrl: 'https://eduescapeacademy.thrivecart.com/escape-room-santas-schlittenherz/?ref=landingpage' },
