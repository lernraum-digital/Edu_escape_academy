...
export const products: Product[] = [
  ...
  { title: 'Der Fluch Interpunctum', description: 'Escape Room rund um Zeichensetzung', level: 'Klassen 6/7–13', image: './assets/products/interpunctum.png', mobileImage: './assets/products/interpunctum-mobile.png', category: 'escape' },
